                    ...
                    <div class="card-body">
                      ...
                      <div id="pay-invoice">
                          <div class="card-body">
                              ...
                              <hr>
                            {{ Form::model($post,['route' => ['admin.post.update', $post->id], 'method' => 'put', 'enctype' =>'multipart/form-data']) }}
                              ...
                              <div class="form-group">
                                ...
                                {{ Form::select('category_id', $categories, $post->category_id, ['class' => 'form-control standardSelect']) }}                            </div>
