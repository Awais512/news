                ...
                <div class="feature_article_wrapper">
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_title">
                            <h1><a href="single.html">{{$hot_news->title}}</a></h1>
                        </div>
                        <!-- feature_article_title -->

                    <div class="feature_article_date"><a href="{{url('/author')}}/{{$hot_news->creator->id}}" target="_self">{{$hot_news->creator->name}}</a>,<a href="{{url('/author')}}/{{$hot_news->creator->id}}">
...
<div class="widget">
    ...
    @foreach ($share['popular_news'] as $post)
    <div class="media">
        <div class="media-left">
        <a href="{{url('/details')}}/{{$post->slug}}"><img class="media-object" src="{{asset('/post/'.$post->thumb_image)}}" width="60" height="60" alt="{{$post->title}}"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
            <a href="{{url('/details')}}/{{$post->slug}}">{!! $post->short_desc !!}</a>
            </h3> <span class="media-date"><a href="#">{{date('j F -Y', strtotime($post->created_at))}}</a>,  by: <a href="{{url('/author')}}/{{$post->creator->id}}">{{$post->creator->name}}</a></span>
...
<div class="widget m30">
    ...
    @foreach ($share['most_commented'] as $post)
    <div class="media">
        <div class="media-left">
        <a href="{{url('/details')}}/{{$post->slug}}"><img class="media-object" src="{{asset('/post/'.$post->thumb_image)}}" width="80" height="80" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
